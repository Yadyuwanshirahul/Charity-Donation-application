...
public class OtherListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (InternetConnection.isInternetAvailable(OtherListActivity.this)) {
    ...
    private void loadJSONProduct() {
        ...
        Call<OtherList> call = api.getAllOtherList();
            ...
            public void onResponse(Call<OtherList> call, Response<OtherList> response) {
                if (response.isSuccessful()) {
                    ...
                    if (categoryItems != null && categoryItems.size() > 0) {
                        ...
                        otherAdapter = new OtherAdapter(getApplicationContext(),otherlist);
